  ...
  return (
    <div className="min-h-screen bg-gray-50 flex font-sans overflow-hidden">
      ...
      <main className="flex-1 ml-72 p-8 z-10 relative h-screen overflow-y-auto scroll-smooth">
        ...
        <header className="mb-10 text-gray-900 flex justify-between items-start">
          <div>
          ...
          <button 
            onClick={() => navigate('/admin/credencial')}
            className="flex items-center gap-2 bg-alta-green text-white px-4 py-2 rounded-xl shadow hover:bg-alta-green/90 transition-colors"
          >
            Acessar Teste Credencial
          </button>
        </header>
